...
-- Disable user triggers during seeding to avoid conflicts
ALTER TABLE threads DISABLE TRIGGER USER;
ALTER TABLE comments DISABLE TRIGGER USER;
ALTER TABLE users DISABLE TRIGGER USER;
ALTER TABLE thread_votes DISABLE TRIGGER USER;
ALTER TABLE comment_votes DISABLE TRIGGER USER;
...
BEGIN
  ...
  FOR thread IN SELECT id, created_at, category_id FROM threads LOOP
    ...
    FOR i IN 1..comment_count LOOP
      ...
      comment_content := COALESCE(content_variants[variant_index], 'Nice post! 👍');
...
-- Re-enable user triggers after seeding
ALTER TABLE users ENABLE TRIGGER USER;
ALTER TABLE threads ENABLE TRIGGER USER;
ALTER TABLE comments ENABLE TRIGGER USER;
ALTER TABLE thread_votes ENABLE TRIGGER USER;
ALTER TABLE comment_votes ENABLE TRIGGER USER;
